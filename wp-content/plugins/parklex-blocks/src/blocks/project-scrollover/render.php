...
<section <?php echo bis_get_block_prop($block, true, ['class' => 'alignfull']); ?>>
	<div class="b-project-scrollover__wrapper is-prose alignwide">
		<div class="b-project-scrollover__inner is-prose">
			<?php echo $content; ?>
		</div>
	</div>
	...
	<div class="b-project-scrollover__spacer" style="height: 100lvh; width: 100%;"></div>
</section>