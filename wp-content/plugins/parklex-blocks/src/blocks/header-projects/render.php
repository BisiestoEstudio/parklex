...
<section <?php echo bis_get_block_prop( $block, false, array( 'class' => 'alignfull' ) ); ?>>
	<div class="b-header-projects__wrapper alignwide">
		<div class="b-header-projects__media">
			<?php if ( $featured_id ) : ?>
				<?php echo wp_get_attachment_image( $featured_id, 'large', false, array( 'class' => 'b-header-projects__main-img' ) ); ?>
			<?php endif; ?>
		</div>

		<div class="b-header-projects__info">
			<div class="b-header-projects__intro">
				<h1 class="b-header-projects__title"><?php echo esc_html( get_the_title( $post_id ) ); ?></h1>
				<?php if ( $author_names ) : ?>
					<p class="b-header-projects__author"><?php echo esc_html( implode( ', ', $author_names ) ); ?></p>
				<?php endif; ?>
			</div>

			<div class="b-header-projects__spec b-header-projects__spec--year">
			...
			<div class="b-header-projects__spec b-header-projects__spec--location">
			...
			<div class="b-header-projects__spec b-header-projects__spec--product">
			...
			<div class="b-header-projects__spec b-header-projects__spec--acabado">
			...
			<div class="b-header-projects__spec b-header-projects__spec--photo">
			...
			<div class="b-header-projects__spec b-header-projects__spec--worktype">
			...
			<div class="b-header-projects__spec b-header-projects__spec--solutions">
